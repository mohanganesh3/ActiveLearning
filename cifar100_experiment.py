#!/usr/bin/env python3
"""CIFAR-100 Active Learning Experiments"""
...
def run_experiment(strategy_name, strategy_class, args, device):
    ...
    for round_num in range(args.rounds):
        ...
        # Select new samples FIRST (before training), starting from round 2
        sampling_time = 0
        ...
        model = VGG(num_classes=100).to(device)
    ...
    output_dir = Path('cifar100_results')
...
def main():
    parser = argparse.ArgumentParser(description='CIFAR-100 Active Learning')
